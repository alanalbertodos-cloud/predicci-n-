...
# Clasificación
if prediccion < 1800:
    st.error("Consumo calórico insuficiente")
elif prediccion <= 2800:
    st.success("Consumo calórico adecuado")
elif prediccion <= 3500:
    st.warning("Consumo calórico elevado")
else:
    st.error("Consumo calórico excesivo")
